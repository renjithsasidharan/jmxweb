...
(function(){var builder=function(cubism,Jolokia){var VERSION="1.1.1";var ctx_jolokia=function(url,opts){var source={},context=this,j4p=createAgent(url,opts),step=5e3;context.on("start",function(){j4p.start();});context.on("stop",function(){j4p.stop();});source.metric=function(){var values=[];var name;var argsLen=arguments.length;var options={};var lastIdx=arguments.length-1;var lastArg=arguments[lastIdx];if(typeof lastArg=="string"){name=lastArg;argsLen=lastIdx;}
